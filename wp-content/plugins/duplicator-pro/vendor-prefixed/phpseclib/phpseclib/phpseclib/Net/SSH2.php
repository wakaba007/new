...
class SSH2
{
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \VendorDuplicator\phpseclib3\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     */
     ...
     *
     * @param string $username
     * @param \VendorDuplicator\phpseclib3\System\SSH\Agent $agent
     * @return bool
     */
     ...
     *
     * @param string $username
     * @param \VendorDuplicator\phpseclib3\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     */
     ...
     * @throws \VendorDuplicator\phpseclib3\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     */
