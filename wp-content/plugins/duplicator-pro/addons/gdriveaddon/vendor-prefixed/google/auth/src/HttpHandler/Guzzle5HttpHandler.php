 ...
 */
namespace VendorDuplicator\Google\Auth\HttpHandler;

use Exception;
use VendorDuplicator\GuzzleHttp\ClientInterface;
use VendorDuplicator\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('VendorDuplicator\\GuzzleHttp\\Promise\\Promise')) {
