...
class FetchAuthTokenCache implements FetchAuthTokenInterface, GetQuotaProjectInterface, SignBlobInterface, ProjectIdProviderInterface, UpdateMetadataInterface
{
    ...
    public function getClientName(callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof SignBlobInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'VendorDuplicator\\Google\\Auth\\SignBlobInterface');
        }
    ...
    public function getProjectId(callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof ProjectIdProviderInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'VendorDuplicator\\Google\\Auth\\ProvidesProjectIdInterface');
        }
    ...
    public function updateMetadata($metadata, $authUri = null, callable $httpHandler = null)
    {
        if (!$this->fetcher instanceof UpdateMetadataInterface) {
            throw new \RuntimeException('Credentials fetcher does not implement ' . 'VendorDuplicator\\Google\\Auth\\UpdateMetadataInterface');
        }
