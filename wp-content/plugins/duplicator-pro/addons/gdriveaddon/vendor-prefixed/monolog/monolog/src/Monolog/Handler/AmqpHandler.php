...
use VendorDuplicator\Monolog\Formatter\JsonFormatter;
use VendorDuplicator\PhpAmqpLib\Message\AMQPMessage;
use VendorDuplicator\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
