...
class SetCookie
{
     ...
     *
     * @param $cookie Set-Cookie header string
     *
     * @return self
     */
     ...
     *
     * @param $secure Set to true or false if secure
     */
     ...
     *
     * @param $discard Set to true or false if this is a session cookie
     */
     ...
     *
     * @param $httpOnly Set to true or false if this is HTTP only
     */
     ...
     *
     * @param $requestPath Path to check against
     *
     * @return bool
     */
