...
class CookieJar implements CookieJarInterface
{
    ...
    private $strictMode;
    /**
     * @param $strictMode   Set to true to throw exceptions when invalid
     ...
     * @param $domain  Domain to set the cookies to
     *
     * @return self
     */
     ...
     * @param $allowSessionCookies If we should persist session cookies
     * @return bool
     */
