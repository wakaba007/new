...
use VendorDuplicator\Dropbox\GuzzleHttp\Cookie\CookieJar;
use VendorDuplicator\Dropbox\GuzzleHttp\Exception\GuzzleException;
use VendorDuplicator\Dropbox\GuzzleHttp\Promise;
...
use VendorDuplicator\Dropbox\Psr\Http\Message\UriInterface;
/**
...
class Client implements ClientInterface
{
     ...
     *
     * @see \VendorDuplicator\Dropbox\GuzzleHttp\RequestOptions for a list of available request options.
     */
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \VendorDuplicator\Dropbox\GuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
