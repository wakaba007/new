...
namespace VendorDuplicator\Dropbox\Psr\Http\Message;
...
interface UriInterface
{
     ...
     * @param null|$password The password associated with $user.
     ...
     * information.
     *
     * @param null|$port The port to use with the new instance; a null value
