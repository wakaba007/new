...
namespace VendorDuplicator\Aws\Handler\GuzzleV6;
...
class GuzzleHandler
{
    ...
    {
        $request = $request->withHeader('User-Agent', $request->getHeaderLine('User-Agent') . ' ' . \VendorDuplicator\GuzzleHttp\default_user_agent());
