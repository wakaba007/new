...
namespace VendorDuplicator\Aws\Endpoint\UseDualstackEndpoint;

use VendorDuplicator\Aws\AbstractConfigurationProvider;
use VendorDuplicator\Aws\CacheInterface;
use VendorDuplicator\Aws\ConfigurationProviderInterface;
use VendorDuplicator\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use($region, $profile, $filename) {
            ...
            $data = \VendorDuplicator\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
