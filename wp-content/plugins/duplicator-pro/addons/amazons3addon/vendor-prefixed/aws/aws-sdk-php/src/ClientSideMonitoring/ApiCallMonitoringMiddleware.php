...
class ApiCallMonitoringMiddleware extends AbstractMonitoringMiddleware
{
     ...
     * @var array
     */
    private static $eventKeys = ['FinalAwsException' => 'VendorDuplicator\\AwsException', 'FinalAwsExceptionMessage' => 'VendorDuplicator\\AwsExceptionMessage', 'FinalSdkException' => 'SdkException', 'FinalSdkExceptionMessage' => 'SdkExceptionMessage', 'FinalHttpStatusCode' => 'HttpStatusCode'];
    /**
