...
namespace VendorDuplicator\Aws\EndpointV2\Rule;

use VendorDuplicator\Aws\EndpointV2\Ruleset\RulesetStandardLibrary;
use VendorDuplicator\Aws\EndpointV2\Ruleset\RulesetEndpoint;
