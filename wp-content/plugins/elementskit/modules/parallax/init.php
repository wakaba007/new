...
class Init{
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'elementskit-parallax-frontend-defer', $this->url . 'assets/js/parallax-frontend.js', array('jquery', 'animejs'), \ElementsKit::version(), true );
	}

	public function editor_scripts(){
		wp_enqueue_script( 'elementskit-parallax-admin-defer', $this->url . 'assets/js/parallax-admin.js', array('jquery', 'elementor-frontend'), \ElementsKit::version(), true );
	}
