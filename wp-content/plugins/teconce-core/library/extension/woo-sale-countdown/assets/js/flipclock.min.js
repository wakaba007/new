...
(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        label_mm: 'm',
        label_ss: 'secs',
        separator: '<i class="teconce-icon-colon"></i>',
        separator_days: ','
    };
    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                '<p class="teconce-count-value-ct">',
                '<span class="teconce-count-value item item-dd">',
                    '<span class="dd"></span>',
                ...
                '<p class="teconce-count-value-ct">',
                '<span class="teconce-count-value item item-hh">',
                    '<span class="hh-1"></span>',
                    '<span class="hh-2"></span>',
                ...
                '<p class="teconce-count-value-ct">',
                '<span class="teconce-count-value item item-mm">',
                    '<span class="mm-1"></span>',
                    '<span class="mm-2"></span>',
                '</span>',
                ...
                '<p class="teconce-count-value-ct">',
                '<span class="teconce-count-value item item-ss">',
                    '<span class="ss-1"></span>',
                    '<span class="ss-2"></span>',
                '</span>',
