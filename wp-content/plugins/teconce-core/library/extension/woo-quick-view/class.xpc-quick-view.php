...
* main class
*/
if ( !class_exists( 'XPC_Product_Quick_View' ) ) {
	/**
	* XPC_Product_Quick_View
	*/
	class XPC_Product_Quick_View {
		...
		public function load_scripts() {
			wp_enqueue_style( 'xpc-product-quick-view', PATH . '/assets/css/style.css' );
            ...
            wp_enqueue_script( 'wc-add-to-cart-variable-product-swatches', PATH . '/assets/js/wc-variation-swatches.js', array( 'jquery' ), '20150810', true );
			...
			if ( $lightbox_enabled ) {
				...
				wp_enqueue_script( 'xpc-product-quick-view', PATH . '/assets/js/xpc-product-quick-view.js', array( 'jquery' ), '20150508', true );
			} else {
				wp_enqueue_script( 'xpc-product-quick-view', PATH . '/assets/js/xpc-product-quick-view-without-prettyphoto.js', array( 'jquery' ), '20150508', true );
			}
		}
			...
			if ( $product_id ) {
				...
				if ( $wp_query->have_posts() ) {
					...
					while ( $wp_query->have_posts() ) : $wp_query->the_post();
						...
						xpcqv_get_template_part( 'xpcqv-product', $params );
